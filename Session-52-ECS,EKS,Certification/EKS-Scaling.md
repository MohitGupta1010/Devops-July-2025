...
kubectl get pods
kubectl autoscale deployment nginx --cpu=50% --min=2 --max=10
kubectl get hpa # by default you can seee 0%/50%
...
kubectl run load-generator4 --image=busybox -- /bin/sh -c "while true; do wget -q -O- http://nginx; done"

kubectl get hpa # check

kubectl get pods # you can see mnewly created pod
